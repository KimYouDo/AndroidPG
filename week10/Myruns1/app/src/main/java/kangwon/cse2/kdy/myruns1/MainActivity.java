...
public class MainActivity extends AppCompatActivity {
    ...
    private void saveUserInfo()
    {
        ...
        localEditor.putString("name", ((EditText)findViewById(R.id.editText)).getText().toString());
        localEditor.putString("email", ((EditText)findViewById(R.id.editText2)).getText().toString());
        localEditor.putString("phone", ((EditText)findViewById(R.id.editText3)).getText().toString());
        localEditor.putString("class", ((EditText)findViewById(R.id.editText4)).getText().toString());
        localEditor.putString("major", ((EditText)findViewById(R.id.editText5)).getText().toString());
        localEditor.putBoolean("is_female", ((RadioButton)findViewById(R.id.radioButton)).isChecked());
        localEditor.putBoolean("is_male", ((RadioButton)findViewById(R.id.radioButton2)).isChecked());
    ...
    private void loadUserInfo()
    {
        ...
        ((EditText)findViewById(R.id.editText)).setText(localSharedPreferences.getString("name", ""));
        ((EditText)findViewById(R.id.editText2)).setText(localSharedPreferences.getString("email", ""));
        ((EditText)findViewById(R.id.editText3)).setText(localSharedPreferences.getString("phone", ""));
        ((EditText)findViewById(R.id.editText4)).setText(localSharedPreferences.getString("class", ""));
        ((EditText)findViewById(R.id.editText4)).setText(localSharedPreferences.getString("major", ""));
        ((RadioButton)findViewById(R.id.radioButton)).setChecked(localSharedPreferences.getBoolean("is_female", false));
        ((RadioButton)findViewById(R.id.radioButton2)).setChecked(localSharedPreferences.getBoolean("is_male", false));
