...
public class UserProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Find tempPhoto path
        File tempPhoto = new File(getFilesDir().getAbsolutePath() +
                "/" + TEMP_IMAGE_FILENAME);
    ...
    public void selectSave(View v) {
        ...
        File tempPhoto = new File(getFilesDir().getAbsolutePath() + "/" + TEMP_IMAGE_FILENAME);
        ...
        if (requestCode == WRITE_PERMISSION_CHECK_CODE && grantResults.length > 0) {
            ...
            if (grantResults[0] == PackageManager.PERMISSION_DENIED) {
                ...
                if (ActivityCompat.shouldShowRequestPermissionRationale(this, Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
                    ...
                    // 사용자를 더 이상 귀찮게 하지 말고 사진 변경 기능 자체를 불능화한다.
    ...
    // 카메라 앱 액티비티나 cropping 앱 액티비티가 완료되면 이 메소드가 호출된다.
