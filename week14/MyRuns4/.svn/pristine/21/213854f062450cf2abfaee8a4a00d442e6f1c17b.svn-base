        ...
        implements OnMapReadyCallback, ServiceConnection
{
    ...
    public void saveEntryToDb()
    {
        ...
        new WriteToDB().execute(new ExerciseEntry[] { localExerciseEntry });
    }
    ...
    private class WriteToDB extends AsyncTask<ExerciseEntry, Integer, String>
    {
        ...
        {
            Toast.makeText(MapEntryActivity.this.getApplicationContext(), "Entry #" + paramString + " saved.", Toast.LENGTH_SHORT).show();
        }
    }
}