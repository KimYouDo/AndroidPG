    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        switch (dialog_id) {
            ...
            case HEARTRATE_PICKER_ID:
                buildEditPickerDialog(dialogBuilder, parent, "맥박 수",dialog_id);
                return dialogBuilder.create();
                ...
                switch (title) {
                    case "지속 시간":
                        ...
                        ((ManualEntryActivity) parent).entry.
                                setDuration(!value.equals("") ? valueInSeconds : 0);
                        break;
                    case "거리":
                        double val;
                        if(!value.equals(""))
                        ...
                        ((ManualEntryActivity) parent).entry.
                                setDistance(!value.equals("") ? val : 0);
                        break;
                    case "칼로리":
                        ((ManualEntryActivity) parent).entry.
                                setCalories(!value.equals("") ? Integer.parseInt(value) : 0);
                        break;
                    case "맥박 수":
                        ((ManualEntryActivity) parent).entry.
                                setHeartRate(!value.equals("") ? Integer.parseInt(value) : 0);
                        break;
                    case "메모":
                        ((ManualEntryActivity) parent).entry.setComment(value);
                        break;
                }
                return;
            }
